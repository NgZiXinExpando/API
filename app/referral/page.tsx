...
const ReferralForm: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto mt-12 p-10 bg-white rounded-xl shadow-lg">
      <h2 className="text-4xl font-extrabold mb-6 text-blue-700 text-center">Make a Referral</h2>
      <p className="text-lg mb-8 text-center text-gray-700">Partners can refer new bulk buyers to Drinkaroo and help us grow. Please fill out the form below with accurate details.</p>
      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <label className="block mb-2 font-semibold text-gray-700">Program</label>
            <select
              value={program}
          ...
          <div>
            <label className="block mb-2 font-semibold text-gray-700">Lead Name</label>
            <input
              type="text"
              value={leadName}
        ...
        <div>
          <label className="block mb-2 font-semibold text-gray-700">Lead Description</label>
          <textarea
